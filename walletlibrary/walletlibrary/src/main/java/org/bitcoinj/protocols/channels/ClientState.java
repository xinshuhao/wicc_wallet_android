...
public final class ClientState {
  ...
  public interface StoredClientPaymentChannelsOrBuilder extends
     ...
     */
    java.util.List<StoredClientPaymentChannel>
        getChannelsList();
    /**
     * <code>repeated .paymentchannels.StoredClientPaymentChannel channels = 1;</code>
     */
    StoredClientPaymentChannel getChannels(int index);
    /**
     * <code>repeated .paymentchannels.StoredClientPaymentChannel channels = 1;</code>
     */
     ...
     * <code>repeated .paymentchannels.StoredClientPaymentChannel channels = 1;</code>
     */
    java.util.List<? extends StoredClientPaymentChannelOrBuilder>
        getChannelsOrBuilderList();
    /**
     * <code>repeated .paymentchannels.StoredClientPaymentChannel channels = 1;</code>
     */
    StoredClientPaymentChannelOrBuilder getChannelsOrBuilder(
            int index);
  }
  /**
   * <pre>
  ...
  public  static final class StoredClientPaymentChannels extends
          ...
          switch (tag) {
            ...
            case 10: {
              if (!((mutable_bitField0_ & 0x00000001) == 0x00000001)) {
                channels_ = new java.util.ArrayList<StoredClientPaymentChannel>();
                mutable_bitField0_ |= 0x00000001;
              }
              channels_.add(
                  input.readMessage(StoredClientPaymentChannel.PARSER, extensionRegistry));
              break;
            }
          }
        }
    ...
    protected FieldAccessorTable
      ...
      return ClientState.internal_static_paymentchannels_StoredClientPaymentChannels_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              StoredClientPaymentChannels.class, Builder.class);
    }

    public static final int CHANNELS_FIELD_NUMBER = 1;
    private java.util.List<StoredClientPaymentChannel> channels_;
    /**
     * <code>repeated .paymentchannels.StoredClientPaymentChannel channels = 1;</code>
     */
    public java.util.List<StoredClientPaymentChannel> getChannelsList() {
      return channels_;
    }
    /**
     * <code>repeated .paymentchannels.StoredClientPaymentChannel channels = 1;</code>
     */
    public java.util.List<? extends StoredClientPaymentChannelOrBuilder>
        getChannelsOrBuilderList() {
      return channels_;
    }
    /**
     ...
     * <code>repeated .paymentchannels.StoredClientPaymentChannel channels = 1;</code>
     */
    public StoredClientPaymentChannel getChannels(int index) {
      return channels_.get(index);
    }
    /**
     * <code>repeated .paymentchannels.StoredClientPaymentChannel channels = 1;</code>
     */
    public StoredClientPaymentChannelOrBuilder getChannelsOrBuilder(
        int index) {
      return channels_.get(index);
    }
    ...
    public boolean equals(final Object obj) {
      ...
      StoredClientPaymentChannels other = (StoredClientPaymentChannels) obj;
    ...
    public static StoredClientPaymentChannels parseFrom(
    ...
    public static StoredClientPaymentChannels parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static StoredClientPaymentChannels parseFrom(
    ...
    public static StoredClientPaymentChannels parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static StoredClientPaymentChannels parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static StoredClientPaymentChannels parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(StoredClientPaymentChannels prototype) {
    ...
    public static final class Builder extends
      ...
      public StoredClientPaymentChannels build() {
        StoredClientPaymentChannels result = buildPartial();
      ...
      public StoredClientPaymentChannels buildPartial() {
        StoredClientPaymentChannels result = new StoredClientPaymentChannels(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof StoredClientPaymentChannels) {
          return mergeFrom((StoredClientPaymentChannels)other);
        } else {
      ...
      public Builder mergeFrom(StoredClientPaymentChannels other) {
        if (other == StoredClientPaymentChannels.getDefaultInstance()) return this;
        if (channelsBuilder_ == null) {
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        StoredClientPaymentChannels parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (StoredClientPaymentChannels) e.getUnfinishedMessage();
      ...
      private void ensureChannelsIsMutable() {
        if (!((bitField0_ & 0x00000001) == 0x00000001)) {
          channels_ = new java.util.ArrayList<StoredClientPaymentChannel>(channels_);
          bitField0_ |= 0x00000001;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          StoredClientPaymentChannel, StoredClientPaymentChannel.Builder, StoredClientPaymentChannelOrBuilder> channelsBuilder_;
      ...
      public Builder setChannels(
          int index, StoredClientPaymentChannel value) {
        if (channelsBuilder_ == null) {
          if (value == null) {
       ...
       */
      public Builder setChannels(
          int index, StoredClientPaymentChannel.Builder builderForValue) {
        if (channelsBuilder_ == null) {
          ensureChannelsIsMutable();
       ...
       * <code>repeated .paymentchannels.StoredClientPaymentChannel channels = 1;</code>
       */
      public Builder addChannels(StoredClientPaymentChannel value) {
        if (channelsBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addChannels(
          StoredClientPaymentChannel.Builder builderForValue) {
        if (channelsBuilder_ == null) {
          ensureChannelsIsMutable();
      ...
      public Builder addAllChannels(
          Iterable<? extends StoredClientPaymentChannel> values) {
        if (channelsBuilder_ == null) {
          ensureChannelsIsMutable();
       ...
       * <code>repeated .paymentchannels.StoredClientPaymentChannel channels = 1;</code>
       */
      public StoredClientPaymentChannel.Builder getChannelsBuilder(
          int index) {
      ...
      public StoredClientPaymentChannel.Builder addChannelsBuilder() {
        return getChannelsFieldBuilder().addBuilder(
            StoredClientPaymentChannel.getDefaultInstance());
      }
      /**
       * <code>repeated .paymentchannels.StoredClientPaymentChannel channels = 1;</code>
       */
      public StoredClientPaymentChannel.Builder addChannelsBuilder(
          int index) {
        return getChannelsFieldBuilder().addBuilder(
            index, StoredClientPaymentChannel.getDefaultInstance());
      }
      /**
       * <code>repeated .paymentchannels.StoredClientPaymentChannel channels = 1;</code>
       */
      public java.util.List<StoredClientPaymentChannel.Builder>
           getChannelsBuilderList() {
        return getChannelsFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          StoredClientPaymentChannel, StoredClientPaymentChannel.Builder, StoredClientPaymentChannelOrBuilder>
          getChannelsFieldBuilder() {
        if (channelsBuilder_ == null) {
    ...
    @Deprecated public static final com.google.protobuf.Parser<StoredClientPaymentChannels>
  ...
  public  static final class StoredClientPaymentChannel extends
    ...
    protected FieldAccessorTable
      ...
      return ClientState.internal_static_paymentchannels_StoredClientPaymentChannel_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              StoredClientPaymentChannel.class, Builder.class);
    }
    ...
    public boolean equals(final Object obj) {
      ...
      StoredClientPaymentChannel other = (StoredClientPaymentChannel) obj;
      ...
      result = result && (hasRefundTransaction() == other.hasRefundTransaction());
      if (hasRefundTransaction()) {
        result = result && getRefundTransaction()
            .equals(other.getRefundTransaction());
      }
      result = result && (hasMyPublicKey() == other.hasMyPublicKey());
      if (hasMyPublicKey()) {
      ...
      result = result && (hasValueToMe() == other.hasValueToMe());
      if (hasValueToMe()) {
        result = result && (getValueToMe()
            == other.getValueToMe());
      }
      result = result && (hasRefundFees() == other.hasRefundFees());
      if (hasRefundFees()) {
        result = result && (getRefundFees()
            == other.getRefundFees());
      }
      result = result && (hasCloseTransactionHash() == other.hasCloseTransactionHash());
      if (hasCloseTransactionHash()) {
        result = result && getCloseTransactionHash()
            .equals(other.getCloseTransactionHash());
      }
    ...
    public static StoredClientPaymentChannel parseFrom(
        com.google.protobuf.ByteString data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    ...
    public static StoredClientPaymentChannel parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static StoredClientPaymentChannel parseFrom(
    ...
    public static StoredClientPaymentChannel parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseWithIOException(PARSER, input);
    }
    ...
    public static StoredClientPaymentChannel parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static StoredClientPaymentChannel parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(StoredClientPaymentChannel prototype) {
      return DEFAULT_INSTANCE.toBuilder().mergeFrom(prototype);
    }
    public Builder toBuilder() {
      return this == DEFAULT_INSTANCE
    ...
    public static final class Builder extends
      ...
      public StoredClientPaymentChannel build() {
        StoredClientPaymentChannel result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(result);
        }
        return result;
      ...
      public StoredClientPaymentChannel buildPartial() {
        StoredClientPaymentChannel result = new StoredClientPaymentChannel(this);
        int from_bitField0_ = bitField0_;
        int to_bitField0_ = 0;
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof StoredClientPaymentChannel) {
          return mergeFrom((StoredClientPaymentChannel)other);
        } else {
          super.mergeFrom(other);
          return this;
        }
      ...
      public Builder mergeFrom(StoredClientPaymentChannel other) {
        if (other == StoredClientPaymentChannel.getDefaultInstance()) return this;
        if (other.hasId()) {
          setId(other.getId());
        }
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        StoredClientPaymentChannel parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (StoredClientPaymentChannel) e.getUnfinishedMessage();
          throw e.unwrapIOException();
        } finally {
          if (parsedMessage != null) {
            mergeFrom(parsedMessage);
  ...
  bitField0_ |= 0x00000400;
    ...
    @Deprecated public static final com.google.protobuf.Parser<StoredClientPaymentChannel>
  ...
  static {
    ...
    internal_static_paymentchannels_StoredClientPaymentChannel_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_paymentchannels_StoredClientPaymentChannel_descriptor,
        new String[] { "Id", "ContractTransaction", "RefundTransaction", "MyPublicKey", "MyKey", "ValueToMe", "RefundFees", "CloseTransactionHash", "MajorVersion", "ExpiryTime", "ServerKey", });
  }
