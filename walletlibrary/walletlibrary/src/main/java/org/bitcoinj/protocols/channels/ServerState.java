...
public final class ServerState {
  ...
  public interface StoredServerPaymentChannelsOrBuilder extends
     ...
     */
    java.util.List<StoredServerPaymentChannel>
        getChannelsList();
    /**
     * <code>repeated .paymentchannels.StoredServerPaymentChannel channels = 1;</code>
     */
    StoredServerPaymentChannel getChannels(int index);
    /**
     * <code>repeated .paymentchannels.StoredServerPaymentChannel channels = 1;</code>
     */
     ...
     * <code>repeated .paymentchannels.StoredServerPaymentChannel channels = 1;</code>
     */
    java.util.List<? extends StoredServerPaymentChannelOrBuilder>
        getChannelsOrBuilderList();
    /**
     * <code>repeated .paymentchannels.StoredServerPaymentChannel channels = 1;</code>
     */
    StoredServerPaymentChannelOrBuilder getChannelsOrBuilder(
            int index);
  }
  /**
   * <pre>
  ...
  public  static final class StoredServerPaymentChannels extends
          ...
          switch (tag) {
            ...
            case 10: {
              if (!((mutable_bitField0_ & 0x00000001) == 0x00000001)) {
                channels_ = new java.util.ArrayList<StoredServerPaymentChannel>();
                mutable_bitField0_ |= 0x00000001;
              }
              channels_.add(
                  input.readMessage(StoredServerPaymentChannel.PARSER, extensionRegistry));
              break;
            }
          }
        }
    ...
    protected FieldAccessorTable
      ...
      return ServerState.internal_static_paymentchannels_StoredServerPaymentChannels_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              StoredServerPaymentChannels.class, Builder.class);
    }

    public static final int CHANNELS_FIELD_NUMBER = 1;
    private java.util.List<StoredServerPaymentChannel> channels_;
    /**
     * <code>repeated .paymentchannels.StoredServerPaymentChannel channels = 1;</code>
     */
    public java.util.List<StoredServerPaymentChannel> getChannelsList() {
      return channels_;
    }
    /**
     * <code>repeated .paymentchannels.StoredServerPaymentChannel channels = 1;</code>
     */
    public java.util.List<? extends StoredServerPaymentChannelOrBuilder>
        getChannelsOrBuilderList() {
      return channels_;
    }
    /**
     ...
     * <code>repeated .paymentchannels.StoredServerPaymentChannel channels = 1;</code>
     */
    public StoredServerPaymentChannel getChannels(int index) {
      return channels_.get(index);
    }
    /**
     * <code>repeated .paymentchannels.StoredServerPaymentChannel channels = 1;</code>
     */
    public StoredServerPaymentChannelOrBuilder getChannelsOrBuilder(
        int index) {
      return channels_.get(index);
    }
    ...
    public boolean equals(final Object obj) {
      ...
      StoredServerPaymentChannels other = (StoredServerPaymentChannels) obj;
    ...
    public static StoredServerPaymentChannels parseFrom(
    ...
    public static StoredServerPaymentChannels parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static StoredServerPaymentChannels parseFrom(
    ...
    public static StoredServerPaymentChannels parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static StoredServerPaymentChannels parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static StoredServerPaymentChannels parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(StoredServerPaymentChannels prototype) {
    ...
    public static final class Builder extends
      ...
      public StoredServerPaymentChannels build() {
        StoredServerPaymentChannels result = buildPartial();
      ...
      public StoredServerPaymentChannels buildPartial() {
        StoredServerPaymentChannels result = new StoredServerPaymentChannels(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof StoredServerPaymentChannels) {
          return mergeFrom((StoredServerPaymentChannels)other);
        } else {
      ...
      public Builder mergeFrom(StoredServerPaymentChannels other) {
        if (other == StoredServerPaymentChannels.getDefaultInstance()) return this;
        if (channelsBuilder_ == null) {
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        StoredServerPaymentChannels parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (StoredServerPaymentChannels) e.getUnfinishedMessage();
      ...
      private void ensureChannelsIsMutable() {
        if (!((bitField0_ & 0x00000001) == 0x00000001)) {
          channels_ = new java.util.ArrayList<StoredServerPaymentChannel>(channels_);
          bitField0_ |= 0x00000001;
         }
      }

      private com.google.protobuf.RepeatedFieldBuilderV3<
          StoredServerPaymentChannel, StoredServerPaymentChannel.Builder, StoredServerPaymentChannelOrBuilder> channelsBuilder_;
      ...
      public Builder setChannels(
          int index, StoredServerPaymentChannel value) {
        if (channelsBuilder_ == null) {
          if (value == null) {
       ...
       */
      public Builder setChannels(
          int index, StoredServerPaymentChannel.Builder builderForValue) {
        if (channelsBuilder_ == null) {
          ensureChannelsIsMutable();
       ...
       * <code>repeated .paymentchannels.StoredServerPaymentChannel channels = 1;</code>
       */
      public Builder addChannels(StoredServerPaymentChannel value) {
        if (channelsBuilder_ == null) {
          if (value == null) {
            throw new NullPointerException();
          }
       ...
       */
      public Builder addChannels(
          StoredServerPaymentChannel.Builder builderForValue) {
        if (channelsBuilder_ == null) {
          ensureChannelsIsMutable();
      ...
      public Builder addAllChannels(
          Iterable<? extends StoredServerPaymentChannel> values) {
        if (channelsBuilder_ == null) {
          ensureChannelsIsMutable();
       ...
       * <code>repeated .paymentchannels.StoredServerPaymentChannel channels = 1;</code>
       */
      public StoredServerPaymentChannel.Builder getChannelsBuilder(
          int index) {
      ...
      public StoredServerPaymentChannel.Builder addChannelsBuilder() {
        return getChannelsFieldBuilder().addBuilder(
            StoredServerPaymentChannel.getDefaultInstance());
      }
      /**
       * <code>repeated .paymentchannels.StoredServerPaymentChannel channels = 1;</code>
       */
      public StoredServerPaymentChannel.Builder addChannelsBuilder(
          int index) {
        return getChannelsFieldBuilder().addBuilder(
            index, StoredServerPaymentChannel.getDefaultInstance());
      }
      /**
       * <code>repeated .paymentchannels.StoredServerPaymentChannel channels = 1;</code>
       */
      public java.util.List<StoredServerPaymentChannel.Builder>
           getChannelsBuilderList() {
        return getChannelsFieldBuilder().getBuilderList();
      }
      private com.google.protobuf.RepeatedFieldBuilderV3<
          StoredServerPaymentChannel, StoredServerPaymentChannel.Builder, StoredServerPaymentChannelOrBuilder>
          getChannelsFieldBuilder() {
        if (channelsBuilder_ == null) {
    ...
    @Deprecated public static final com.google.protobuf.Parser<StoredServerPaymentChannels>
  ...
  public  static final class StoredServerPaymentChannel extends
    ...
    protected FieldAccessorTable
      ...
      return ServerState.internal_static_paymentchannels_StoredServerPaymentChannel_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              StoredServerPaymentChannel.class, Builder.class);
    }
    ...
    public boolean equals(final Object obj) {
      ...
      StoredServerPaymentChannel other = (StoredServerPaymentChannel) obj;
    ...
    public static StoredServerPaymentChannel parseFrom(
        com.google.protobuf.ByteString data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    ...
    public static StoredServerPaymentChannel parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static StoredServerPaymentChannel parseFrom(
    ...
    public static StoredServerPaymentChannel parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseWithIOException(PARSER, input);
    }
    ...
    public static StoredServerPaymentChannel parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static StoredServerPaymentChannel parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(StoredServerPaymentChannel prototype) {
      return DEFAULT_INSTANCE.toBuilder().mergeFrom(prototype);
    }
    public Builder toBuilder() {
      return this == DEFAULT_INSTANCE
    ...
    public static final class Builder extends
      ...
      public StoredServerPaymentChannel build() {
        StoredServerPaymentChannel result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(result);
        }
        return result;
      ...
      public StoredServerPaymentChannel buildPartial() {
        StoredServerPaymentChannel result = new StoredServerPaymentChannel(this);
        int from_bitField0_ = bitField0_;
        int to_bitField0_ = 0;
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof StoredServerPaymentChannel) {
          return mergeFrom((StoredServerPaymentChannel)other);
        } else {
          super.mergeFrom(other);
          return this;
        }
      ...
      public Builder mergeFrom(StoredServerPaymentChannel other) {
        if (other == StoredServerPaymentChannel.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        StoredServerPaymentChannel parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (StoredServerPaymentChannel) e.getUnfinishedMessage();
          throw e.unwrapIOException();
        } finally {
          if (parsedMessage != null) {
            mergeFrom(parsedMessage);
  ...
  bitField0_ |= 0x00000080;
    ...
    @Deprecated public static final com.google.protobuf.Parser<StoredServerPaymentChannel>
