 ...
 *
 * <p>To be able to serialize and deserialize new Messages subclasses the following criteria needs to be met.</p>
 *
 * <ul>
 ...
 * <li>Messages.bitcoinSerializeToStream() needs to be properly subclassed</li>
 * </ul>
 */
    ...
    public static class BitcoinPacketHeader {
        ...
        public BitcoinPacketHeader(ByteBuffer in) throws ProtocolException, BufferUnderflowException {
            ...
            if (size > Message.MAX_SIZE || size < 0)
                throw new ProtocolException("Messages size too large: " + size);
