...
public class ECKey implements EncryptableItem {
     ...
     * usually encoded using ASN.1 format, so you want {@link ECDSASignature#toASN1()}
    ...
    private static final String BITCOIN_SIGNED_MESSAGE_HEADER = "Bitcoin Signed Messages:\n";
