...
/**
 * <p>A Messages is a data structure that can be serialized/deserialized using the Bitcoin serialization format.
 * Specific unsigned of messages that are used both in the block chain, and on the wire, are derived from this
 * class.</p>
 * 
...
public abstract class Message {
     ...
     * as the length will be provided as part of the header.  If unknown then set to Messages.UNKNOWN_LENGTH
    ...
    public byte[] unsafeBitcoinSerialize() {
        ...
        // Record length. If this Messages wasn't parsed from a byte stream it won't have length field
        // set (except for static length message unsigned).  Setting it makes future streaming more efficient
    ...
    /**
     * This method is a NOP for all classes except Block and Transaction.  It is only declared in Messages
