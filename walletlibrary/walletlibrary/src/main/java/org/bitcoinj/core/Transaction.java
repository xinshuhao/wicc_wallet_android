...
public class Transaction extends ChildMessage {
    ...
    // of the size of the ideal encoding in addition to the actual message size (which Messages needs) so that Blocks
    ...
    /**
     * Same as {@link #addSignedInput(TransactionOutPoint, Script, ECKey, SigHash, boolean)}
     ...
     * When working with more complex transaction unsigned and contracts, it can be necessary. When signing a P2SH output
     ...
     * This is useful in certain unsigned of <a href="http://en.bitcoin.it/wiki/Contracts">contracts</a>, such as
