 ...
 * Integer-based unsigned such as {@link BigInteger} are interpreted as representing a
...
public abstract class BtcFormat extends Format {
     ...
     * {@link BigDecimal}.  Numeric unsigned that can represent only an integer are interpreted
     ...
     * {@link BigInteger}, {@link BigDecimal}.  Numeric unsigned that can represent only
